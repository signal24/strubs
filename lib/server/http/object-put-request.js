...
class ObjectPutRequest {
    ...
    async process() {
        return new Promise(async (resolve, reject) => {
            ...
            this.request.on('aborted', async () => {
                ...
                // destroy the object and do nothing else
                object.destroy();
            });
            ...
            object.on('finish', async () => {
                ...
                // something must've been corrupted along the way, and dwe need to bail now
                ...
                this.response.writeHead(201, 'Created', {
                    'content-md5': md5Hex,
                    'x-object-id': object.id.toString('hex'),
    ...
    log() {
        this.log = Log('http-server:put-request');
