...
class Base {
    constructor(fileObject) {
        ...
        this._standardChunkSetDataSize = null;
        this._standardChunkCountPerSlice = null;
    ...
    _configureInternals() {
        ...
        // TODO: rename chunk set -> stripe. stripe is made of chunks.
        ...
        // slice is going to want to know how many standard data chunks it uses later
        this._standardChunkCountPerSlice = standardChunkCountPerSlice;
    }
    ...
    async _instantiateSlices() {
        for (let index = 0; index < this._totalSliceCount; index++) {
            let slice = new Slice(this.fileObject, this, index);
